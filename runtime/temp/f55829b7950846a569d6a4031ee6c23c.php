<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"E:\phpstudy\phpStudy_2016.11.03\WWW\tmoa\public/../application/admin\view\wlbuser\index.html";i:1523171447;s:73:"E:\phpstudy\phpStudy_2016.11.03\WWW\tmoa\application\admin\view\base.html";i:1523170447;}*/ ?>
...
<ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
    <li>
        <a href="javascript:;"><i class="fa fa-cogs"></i> 网络部成员列表</a>
    </li>       
</ol>
 ...
 <form action="" method="post">
   <div class="panel-body">
      ...
      <tr>
         ...
         <td><a href="<?php echo url('admin/Wlbuser/store',['user_id'=>$vo['user_id']]); ?>">编辑</a></td>
      </tr>
   ...
   <div id="adduser">
    <p><a href="<?php echo url('admin/Wlbuser/add'); ?>" class="btn btn-primary btn-lg" role="button">
          添加成员</a>
         </p>
    </div>
 </form>
