<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"E:\phpstudy\phpStudy_2016.11.03\WWW\tmoa\public/../application/admin\view\xmbuser\store.html";i:1523012327;s:73:"E:\phpstudy\phpStudy_2016.11.03\WWW\tmoa\application\admin\view\base.html";i:1523170447;}*/ ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="user_name" value="<?php echo $oldData['user_name']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">班级</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="user_class" value="<?php echo $oldData['user_class']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">电话</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="user_phone" value="<?php echo $oldData['user_phone']; ?>">
                            </div>
                        </div>
                    </div>
                    </div>
