<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"E:\phpstudy\phpStudy_2016.11.03\WWW\tmoa\public/../application/admin\view\entry\news.html";i:1522920364;s:73:"E:\phpstudy\phpStudy_2016.11.03\WWW\tmoa\application\admin\view\base.html";i:1523170447;}*/ ?>
    ...
    if(obj.event === 'detail'){
      layer.msg('ID：'+ data.news_id + ' 的查看操作');
         ...
         util.confirm('确认删除么',function(){
           location.href="<?php echo url('del_news'); ?>"+'?user_id='+data.news_id;
     })
