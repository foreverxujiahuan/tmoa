<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"E:\phpstudy\phpStudy_2016.11.03\WWW\tmoa\public/../application/admin\view\entry\gtable.html";i:1523169114;s:73:"E:\phpstudy\phpStudy_2016.11.03\WWW\tmoa\application\admin\view\base.html";i:1523015783;}*/ ?>
...
<div class="container-fluid admin_menu">
   ...
   <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
                <li>
                    <a href="javascript:;"><i class="fa fa-cogs"></i> 已提交课表的人员</a>
                </li>       
   </ol>
...
layui.use('table', function(){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      {field:'table_id', title: 'ID', align: 'center',sort: true}
    
       ,{field:'table_username',  title: '真实姓名',align: 'center'}
   
      ,{field:'table_phone',  title: '手机号',align: 'center'}
      ,{field:'table_time',  title: '加入时间',align: 'center',sort: true}
...
layui.use('table', function(){
  ...
  table.on('tool(demo)', function(obj){
    var data = obj.data;
    if(obj.event === 'detail'){
      layer.msg('ID：'+ data.table_id + ' 的查看操作');
    } else if(obj.event === 'del'){
         util.confirm('确认删除么',function(){
           location.href="<?php echo url('del_table'); ?>"+'?user_id='+data.table_id;
     })
