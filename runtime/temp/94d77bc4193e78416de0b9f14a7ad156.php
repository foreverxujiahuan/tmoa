<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"E:\phpstudy\phpStudy_2016.11.03\WWW\tmoa\public/../application/user\view\summary\index.html";i:1522080839;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <title>summary</title>
  ...
  <link rel="stylesheet" href="/static/user/css/bootstrap.min.css">
   ...
   <link rel="stylesheet" href="/static/user/css/summary.css">
    <link href="/static/user/css/daily.css" rel="stylesheet">
           ...
           <div class="D_content  mr-5" style="background-color: #fff;letter-spacing: 2px;"> 
              <div class="row" class="D_left" style="height: 100%; ">
                 <div class="col-3 " style="padding-right: 0px;border-right: 1px solid #000;">            
                         ...
                         <hr>
                           <div class="p-2 list icon_center" data-toggle="modal" data-target="#exampleModalCenter" >
                          <i class="fa fa-angle-right" aria-hidden="true" style="font-size:24px"></i> 周总结与下周计划
                           </div>
                           
                           <div class="p-2 list icon_center"><i class="fa fa-angle-right" style="font-size:24px"></i>月总结与下月计划</div>
                        
                           <div class="p-2 list icon_center"><i class="fa fa-angle-right"  style="font-size:24px"></i>季总结与下季计划</div>
                           <div class="p-2 list icon_center"><i class="fa fa-angle-right" style="font-size:24px"></i>年总结与下年计划</div>
                 ...
                 <div class="col-9" style="padding-left: 0px;">     
                   ...
                   <div class="p-3 text-white" style="background-color: #b2c0d1;"><h5>超级管理员</h5></div>
                    <div class="p-3 text-white " style="border-bottom: 1px solid #000"><button type="button" class="btn btn-primary mr-3">写总结计划</button>
